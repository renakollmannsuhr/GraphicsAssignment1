...
function render(timestamp) {
	...
	// for hierarchical modeling we can use a stack to help us
	// some objects will be parented to others
	// child object moves with parent (IE UPPER SEAWEED MOVES WITH LOWER SEAWEED)
	...
	gPush();
		...
		gPush();
		{
			...
			//cylinder child to cube hierarchical
			/*
